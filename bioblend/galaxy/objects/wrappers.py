...
class History(DatasetContainer):
    ...
    def export(self, gzip=True, include_hidden=False, include_deleted=False, wait=False, maxwait=None):
        """
...
class Tool(Wrapper):
    ...
    def run(self, inputs, history, wait=False, polling_interval=POLLING_INTERVAL):
        """
