...
class TestGalaxyFolders(GalaxyTestBase.GalaxyTestBase):
    ...
    def test_get_set_permissions(self):
        ...
        self.assertEqual(self.gi.folders.get_permissions(self.folder["id"], scope="current"), empty_permission)
        self.assertEqual(self.gi.folders.get_permissions(self.folder["id"], scope="available"), empty_permission)
